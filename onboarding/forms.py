...
#     class Meta:
#         model = Employee
#         fields = ['first_name', 'last_name', 'email', 'phone_number', 'employee_type', 'department', 'position', 'address', 'joining_date']
...
#         model = Employee
#         fields = [
#             'first_name', 'last_name', 'email', 'phone_number', 'employee_type', 'department', 'position', 'address', 'joining_date',
...
#                 'class': 'form-control',
#                 'rows': 3,
#                 'placeholder': 'Enter your complete address including city, state, PIN code'
#             }),
...
#             'address': 'Include complete address with city, state, and PIN code',
...
#         required_fields = [
#             'first_name', 'last_name', 'email', 'phone_number', 'employee_type', 'department', 'position', 'address',
#             'aadhar_pan_file', 'payslips_file', 'educational_certificates_file',
#             'previous_offer_letter_file', 'relieving_experience_letters_file', 'appraisal_hike_letters_file'
#         ]
...
# #     class Meta:
# #         model = Employee
# #         fields = ['first_name', 'last_name', 'email', 'employee_type', 'department', 'position', 'address', 'joining_date']
...
# #         model = Employee
# #         fields = [
# #             'first_name', 'last_name', 'email', 'employee_type', 'department', 'position', 'address', 'joining_date',
# #             'aadhar_pan_file', 'payslips_file', 'educational_certificates_file', 
# #             'previous_offer_letter_file', 'relieving_experience_letters_file', 'appraisal_hike_letters_file'
# #         ]
...
# #         # Make certain fields required for self-submission
# #         required_fields = [
# #             'first_name', 'last_name', 'email', 'employee_type', 'department', 'position', 'address',
# #             'aadhar_pan_file', 'payslips_file', 'educational_certificates_file',
# #             'previous_offer_letter_file', 'relieving_experience_letters_file', 'appraisal_hike_letters_file'
# #         ]
