    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(blank=True, choices=[('de', 'German'), ('en', 'English'), ('es', 'Spanish'), ('fr', 'French'), ('it', 'Italian'), ('nl', 'Dutch'), ('pt-br', 'Portuguese'), ('ru', 'Russian'), ('uk', 'Ukrainian')], default='', max_length=7, verbose_name='Language')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(choices=[('de', 'German'), ('en', 'English'), ('es', 'Spanish'), ('fr', 'French'), ('it', 'Italian'), ('nl', 'Dutch'), ('pt-br', 'Portuguese'), ('ru', 'Russian'), ('uk', 'Ukrainian')], max_length=7, verbose_name='Language')),
