...
class Employee(models.Model):
    ...
    # Add status field for onboarding workflow
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='pending', help_text="Onboarding approval status")
