...
const Settings = () => {
  ...
  const inputClass =
    'block w-full rounded-xl border border-black/10 dark:border-white/10 bg-white/5/5 text-white placeholder-gray-500 shadow-inner px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all duration-200 pr-10';
  ...
  return (
    <div className="min-h-[80vh] space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Account Card */}
        <div className="bg-white/5 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-black/10 dark:border-white/10 overflow-hidden shadow-xl hover:shadow-indigo-500/10 transition-all duration-300">
          <div className="px-6 py-4 border-b border-black/10 dark:border-white/10 bg-white/5/5 flex items-center space-x-3">
        ...
        <div className="bg-white/5 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-black/10 dark:border-white/10 overflow-hidden shadow-xl hover:shadow-indigo-500/10 transition-all duration-300">
          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4 text-sm">
            ...
            {form.new_password.length > 0 && (
              <div className="space-y-3 p-4 rounded-xl bg-white/5/5 border border-black/10 dark:border-white/10">
                {/* Bar */}
            ...
            {form.new_password.length === 0 && (
              <div className="flex items-start space-x-2 p-3 rounded-xl bg-white/5/5 border border-black/10 dark:border-white/10">
