    ...
    <div className="space-y-8 relative z-10">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-slate-900 dark:text-white font-bold rounded-2xl shadow-[0_0_15px_rgba(79,70,229,0.4)] border border-indigo-400/50 transition-all transform hover:scale-105"
        >
            ...
            {leaveBalances.map((balance, idx) => {
              ...
              return (
                <div
                  ...
                  className={`bg-black/5 dark:bg-white/5 p-4 rounded-[2rem] border border-black/10 dark:border-white/10 shadow-lg hover:shadow-indigo-500/10 transition-all hover:-translate-y-1 ${accent.glow}`}
                >
            ...
            <div className="max-w-6xl mx-auto bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-[2.25rem] shadow-2xl overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-black/10 dark:border-white/10">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-900 dark:text-white hover:bg-black/10 dark:bg-white/10 transition-all"
                  aria-label="Close"
                  title="Close"
                >
                  X
              ...
              <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] h-full">
                {/* Left nav */}
                <div className="border-b md:border-b-0 md:border-r border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5">
                  <div className="p-4">
                    {leaveBalances.map((b) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 rounded-2xl border transition-all mb-2 ${isActive
                            ? 'bg-black/10 dark:bg-white/10 border-black/20 dark:border-white/20 text-slate-900 dark:text-white'
                            : 'bg-transparent border-transparent text-slate-500 dark:text-slate-400 hover:bg-black/5 dark:bg-white/5 hover:border-black/10 dark:border-white/10'
                            }`}
                        >
                  ...
                  <div className="flex items-center gap-4 mb-5">
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl font-bold border transition-all ${balanceDetailsTab === 'history'
                        ...
                        : 'bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:bg-black/10 dark:bg-white/10'
                        }`}
                    >
                      Balance history
                    </button>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <input
              ...
              className="block w-full bg-[#0A0F1A] border-black/10 dark:border-white/10 rounded-xl text-slate-900 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-medium [color-scheme:dark]"
            />
          </div>
      ...
      <div className="bg-black/5 dark:bg-white/5 backdrop-blur-xl shadow-2xl rounded-[2rem] border border-black/10 dark:border-white/10 overflow-hidden">
        <ul className="divide-y divide-white/5">
          {leaveRequests.length === 0 ? (
            ...
            leaveRequests.map((request) => (
              <li key={request.id}>
                <div className="px-8 py-6 hover:bg-black/5 dark:bg-white/5 transition-all">
                  <div className="flex items-center justify-between">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                step="0.5"
                readOnly
                className="block w-full bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 rounded-xl text-slate-500 dark:text-slate-400 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-medium cursor-not-allowed"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="border-2 border-dashed border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 rounded-2xl p-8 text-center hover:border-indigo-400/50 transition-colors">
          ...
          <div className="flex justify-end space-x-4 pt-8 border-t border-black/10 dark:border-white/10 mt-8">
            <button
              ...
              className="px-8 py-3 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:bg-white/10 text-slate-900 dark:text-white font-bold rounded-2xl border border-black/10 dark:border-white/10 transition-all"
            >
              Cancel
            </button>
            <button
      ...
      >
        {selectedRequest && (
          <div className="space-y-8">
            {/* Employee Info */}
            {isHRManager() && (
              <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/10 dark:border-white/10 shadow-lg">
            ...
            {selectedRequest.employee_comments && (
              <div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/10 dark:border-white/10 shadow-inner">
            ...
            {selectedRequest.approved_by_name && (
              <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/10 dark:border-white/10 shadow-lg flex justify-between items-center">
                <div>
