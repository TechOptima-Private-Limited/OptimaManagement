...
const LeaveApproval = () => {
  ...
  const RequestCard = ({ request, showActions = true }) => {
    ...
    return (
      <div className={`border-l-4 p-8 mb-6 rounded-r-[2rem] shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 bg-white/5/5 backdrop-blur-xl border border-black/10 dark:border-white/10 ${getUrgencyColor(request)}`}>
  ...
  return (
    <div className="space-y-8 relative z-10">
      ...
      <div className="border-b border-black/10 dark:border-white/10">
        <nav className="-mb-px flex space-x-10">
          ...
          >
            <div className="flex items-center">
              Pending Approvals
              <span className={`ml-3 px-3 py-1 rounded-full text-xs ${activeTab === 'pending' ? 'bg-indigo-500/20 text-indigo-300 border border-indigo-500/30' : 'bg-white/5/5 text-slate-400'
                }`}>
          ...
          >
            <div className="flex items-center">
              All Requests
              <span className={`ml-3 px-3 py-1 rounded-full text-xs ${activeTab === 'all' ? 'bg-indigo-500/20 text-indigo-300 border border-indigo-500/30' : 'bg-white/5/5 text-slate-400'
                }`}>
                {allRequests.length}
              </span>
            </div>
      ...
      <div>
        {activeTab === 'pending' ? (
          pendingRequests.length === 0 ? (
            <div className="text-center py-20 bg-white/5/5 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-black/10 dark:border-white/10 relative overflow-hidden">
        ...
        {selectedRequest && (
          <div className="space-y-8 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/5/5 backdrop-blur-md p-6 rounded-2xl border border-black/10 dark:border-white/10 shadow-lg hover:bg-black/10 dark:bg-white/5/10 transition-colors">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="block w-full bg-[#0A0F1A] border-black/10 dark:border-white/10 rounded-2xl text-white shadow-inner focus:ring-emerald-500 focus:border-emerald-500 font-medium placeholder-slate-500 p-4 transition-all"
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 pt-6 border-t border-black/10 dark:border-white/10">
              <button
                ...
                className="flex-1 px-6 py-4 bg-white/5/5 hover:bg-black/10 dark:bg-white/5/10 text-white font-bold rounded-2xl shadow-lg border border-black/10 dark:border-white/10 transition-all transform hover:-translate-y-1"
              >
                Cancel
              </button>
              <button
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="block w-full bg-[#0A0F1A] border-black/10 dark:border-white/10 rounded-2xl text-white shadow-inner focus:ring-rose-500 focus:border-rose-500 font-medium placeholder-slate-500 p-4 transition-all"
