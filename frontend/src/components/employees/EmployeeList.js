  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="fixed inset-0 transition-opacity bg-slate-50 dark:bg-[#070B14]/80 backdrop-blur-md" onClick={onClose}></div>

        {/* Modal centering trick */}
        <span className="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>

        {/* Enhanced modal container */}
        <div className="relative inline-block align-bottom bg-[#0A0F1A] rounded-t-3xl sm:rounded-3xl text-left overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] transform transition-all duration-300 sm:my-8 sm:align-middle w-full sm:max-w-4xl border border-black/10 dark:border-white/10">

          {/* Enhanced header */}
          <div className="relative bg-gradient-to-r from-emerald-900/40 via-teal-900/40 to-[#0A0F1A] px-6 py-6 sm:px-8 border-b border-black/5 dark:border-white/5">
            {/* Decorative elements */}
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Add New Employee</h2>
              ...
              <button
                onClick={onClose}
                className="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-black/10 dark:bg-white/10 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 hidden sm:block"
              >
          ...
          <div className="bg-[#0A0F1A] px-4 sm:px-8 py-6 max-h-[70vh] overflow-y-auto relative z-10 custom-scrollbar">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="bg-slate-50 dark:bg-[#070B14] p-5 rounded-2xl border border-indigo-500/20 shadow-inner relative overflow-hidden group">
                  ...
                  <div className="space-y-4 relative z-10">
                    <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Username <span className="text-rose-500">*</span></label>
                      <input
                        type="text"
                        name="username"
                        value={formData.user.username}
                        onChange={(e) => handleInputChange(e, 'user')}
                        className={`w-full px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600 ${errors.user?.username
                          ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                          : 'border-black/10 dark:border-white/10 focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 hover:border-black/20 dark:border-white/20'
                          }`}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Email <span className="text-rose-500">*</span></label>
                      <div className="relative">
                        <input
                          ...
                          onChange={(e) => handleInputChange(e, 'user')}
                          className={`w-full px-4 py-2.5 pl-11 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600 ${errors.user?.email
                            ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                            : 'border-black/10 dark:border-white/10 focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 hover:border-black/20 dark:border-white/20'
                            }`}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange(e, 'user')}
                          className="w-full px-4 py-2.5 bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-xl shadow-sm focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 hover:border-black/20 dark:border-white/20 transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600"
                          placeholder="Jane"
                        />
                      </div>
              ...
              {/* UserProfile Fields */}
              <div className="space-y-4">
                <div className="bg-slate-50 dark:bg-[#070B14] p-5 rounded-2xl border border-emerald-500/20 shadow-inner relative overflow-hidden group">
                  ...
                  <div className="space-y-4 relative z-10">
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full px-4 py-2.5 bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-xl shadow-sm focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 hover:border-black/20 dark:border-white/20 transition-all duration-300 outline-none appearance-none cursor-pointer text-sm text-slate-900 dark:text-white"
                        >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange(e, 'profile')}
                        className={`w-full px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600 ${errors.profile?.phone_number
                          ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                          : 'border-black/10 dark:border-white/10 focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 hover:border-black/20 dark:border-white/20'
                          }`}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Date of Birth</label>
                        <input
                          type="date"
                          name="date_of_birth"
                      ...
                      <div>
                        <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Emergency</label>
                        <input
                          type="text"
              ...
              <div className="md:col-span-2">
                <div className="bg-slate-50 dark:bg-[#070B14] p-5 rounded-2xl border border-violet-500/20 shadow-inner relative overflow-hidden group">
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleInputChange(e, 'profile')}
                    className="w-full px-4 py-3 bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-xl shadow-sm focus:border-violet-500/50 focus:ring-4 focus:ring-violet-500/10 hover:border-black/20 dark:border-white/20 transition-all duration-300 outline-none resize-none text-sm text-slate-900 dark:text-white placeholder-slate-600 relative z-10"
              ...
              {/* Employee Fields */}
              <div className="md:col-span-2">
                <div className="bg-slate-50 dark:bg-[#070B14] p-5 rounded-2xl border border-rose-500/20 shadow-inner relative overflow-hidden group">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative z-10">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600 ${errors.employee_id
                          ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                          : 'border-black/10 dark:border-white/10 focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 hover:border-black/20 dark:border-white/20'
                          }`}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Department <span className="text-rose-500">*</span></label>
                      <div className="relative">
                        <select
                          name="department_id"
                          value={formData.department_id}
                          onChange={handleInputChange}
                          className={`w-full px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white appearance-none cursor-pointer ${errors.department_id
                            ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                            : 'border-black/10 dark:border-white/10 focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 hover:border-black/20 dark:border-white/20'
                            }`}
                          required
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Position <span className="text-rose-500">*</span></label>
                      <input
                        type="text"
                        name="position"
                        value={formData.position}
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white placeholder-slate-600 ${errors.position
                          ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                          : 'border-black/10 dark:border-white/10 focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 hover:border-black/20 dark:border-white/20'
                          }`}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Hire Date <span className="text-rose-500">*</span></label>
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`flex-1 px-4 py-2.5 bg-[#0A0F1A] border rounded-xl shadow-sm transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white [color-scheme:dark] ${errors.hire_date
                            ? 'border-rose-500/50 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10'
                            : 'border-black/10 dark:border-white/10 focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 hover:border-black/20 dark:border-white/20'
                            }`}
                          required
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Direct Manager</label>
                      <div className="relative">
                        <select
                          name="manager"
                          value={formData.manager}
                          onChange={handleInputChange}
                          className="w-full px-4 py-2.5 bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-xl shadow-sm focus:border-rose-500/50 focus:ring-4 focus:ring-rose-500/10 hover:border-black/20 dark:border-white/20 transition-all duration-300 outline-none text-sm text-slate-900 dark:text-white appearance-none cursor-pointer"
                        >
          ...
          {/* Enhanced Footer */}
          <div className="bg-black/5 dark:bg-white/5 px-6 py-5 sm:px-8 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-black/5 dark:border-white/5 relative z-10 backdrop-blur-md">
            <button
              type="button"
              onClick={onClose}
              className="w-full sm:w-auto inline-flex justify-center rounded-xl border border-black/10 dark:border-white/10 px-6 py-2.5 bg-transparent text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-black/5 dark:bg-white/5 hover:text-slate-900 dark:text-white transition-all duration-300"
            >
              Cancel
            </button>
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto inline-flex justify-center items-center rounded-xl border border-transparent shadow-[0_0_20px_rgba(52,211,153,0.3)] px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-sm font-bold text-slate-900 dark:text-white hover:from-emerald-400 hover:to-teal-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/30 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5 transition-all duration-300"
            >
              {loading ? (
                <div className="flex items-center space-x-2">
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="relative inline-block align-bottom bg-[#0A0F1A] rounded-3xl text-left overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-black/10 dark:border-white/10">
          ...
          <div className="px-6 pt-8 pb-6 sm:p-8 sm:pb-6">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-4 text-center sm:mt-0 sm:ml-6 sm:text-left">
                <h3 className="text-xl leading-6 font-black text-slate-900 dark:text-white tracking-tight">
                  Delete Employee
                </h3>
                <div className="mt-3">
                  <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                    Are you sure you want to delete <span className="font-bold text-slate-900 dark:text-white bg-black/5 dark:bg-white/5 px-2 py-0.5 rounded-md border border-black/10 dark:border-white/10">{employee.user_info?.full_name || employee.user?.username || employee.employee_id}</span>?
          ...
          <div className="bg-black/5 dark:bg-white/5 backdrop-blur-md px-6 py-4 sm:flex sm:flex-row-reverse sm:px-8 border-t border-black/5 dark:border-white/5">
            <button
              type="button"
              onClick={onConfirm}
              disabled={loading}
              className="w-full inline-flex justify-center rounded-xl border border-transparent px-6 py-3 bg-rose-600 text-sm font-black text-slate-900 dark:text-white hover:bg-rose-500 hover:shadow-[0_0_20px_rgba(244,63,94,0.4)] transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-rose-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 border-2 border-black/20 dark:border-white/20 border-t-white rounded-full animate-spin"></div>
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-3 w-full inline-flex justify-center rounded-xl border border-black/10 dark:border-white/10 shadow-sm px-6 py-3 bg-black/5 dark:bg-white/5 text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-black/10 dark:bg-white/10 hover:text-slate-900 dark:text-white transition-all duration-300 focus:outline-none sm:mt-0 sm:w-auto"
            >
              Cancel
            </button>
          </div>
...
const EmployeeList = () => {
  ...
  if (loading) {
    return (
      <div className={`min-h-screen bg-slate-50 dark:bg-[#070B14] flex justify-center items-center`}>
        <div className="text-center">
          <div className="relative">
            <div className="w-20 h-20 border-4 border-black/5 dark:border-white/5 rounded-full animate-spin">
          ...
          <p className="mt-6 text-slate-500 dark:text-slate-400 font-medium tracking-wide animate-pulse">Syncing Directory...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070B14] text-slate-800 dark:text-slate-200 selection:bg-indigo-500/30">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl font-medium leading-relaxed">
                Empowering our team through seamless connectivity and expertise Discovery across <span className="text-slate-800 dark:text-slate-200">Optima Management</span>.
              </p>

              <div className="flex flex-wrap items-center gap-6 pt-2">
                <div className="flex items-center space-x-3 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 py-2 rounded-2xl border border-black/10 dark:border-white/10">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-black text-slate-900 dark:text-white">{employees.length} Members</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 py-2 rounded-2xl border border-black/10 dark:border-white/10">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-black text-slate-900 dark:text-white">{departments.length} Departments</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {(isHRManager() || isAdmin()) && (
              <div className="flex-shrink-0">
                <button
                  ...
                  className="group relative inline-flex items-center px-8 py-4 bg-indigo-600 rounded-2xl font-black text-slate-900 dark:text-white shadow-[0_10px_40px_-10px_rgba(79,70,229,0.5)] hover:shadow-[0_15px_50px_-10px_rgba(79,70,229,0.6)] transform hover:-translate-y-1 transition-all duration-300"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-black/5 dark:bg-white/5 backdrop-blur-xl shadow-2xl rounded-3xl border border-black/10 dark:border-white/10 p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 items-end">
          <div className="lg:col-span-5 space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-[#0A0F1A] border border-black/5 dark:border-white/5 rounded-2xl text-slate-900 dark:text-white placeholder-slate-600 focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-300 outline-none font-medium"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-2">
            ...
            <select
              ...
              className="w-full px-4 py-4 bg-[#0A0F1A] border border-black/5 dark:border-white/5 rounded-2xl text-slate-900 dark:text-white focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-300 outline-none appearance-none cursor-pointer font-medium"
            >
          ...
          <div className="lg:col-span-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center px-6 py-4 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-sm font-black text-slate-700 dark:text-slate-300 rounded-2xl hover:bg-black/10 dark:bg-white/10 hover:text-slate-900 dark:text-white transition-all duration-300 group"
            >
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {employees.length === 0 ? (
            <div className="col-span-full text-center py-24 bg-black/5 dark:bg-white/5 rounded-[40px] border border-black/10 dark:border-white/10 backdrop-blur-xl">
              <div className="relative mx-auto w-32 h-32 mb-8">
                <div className="absolute inset-0 bg-indigo-500/20 rounded-full blur-2xl animate-pulse"></div>
                <div className="relative flex items-center justify-center w-full h-full bg-[#0A0F1A] rounded-full border border-black/10 dark:border-white/10">
              ...
              <button
                onClick={clearFilters}
                className="inline-flex items-center px-8 py-4 bg-indigo-600 text-slate-900 dark:text-white rounded-2xl font-black hover:bg-indigo-700 transition-all duration-300"
              >
                Show All Directory
              </button>
            </div>
            ...
            employees.map((employee, index) => {
              ...
              return (
                <div
                  key={employee.id}
                  className="group relative bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-[32px] border border-black/10 dark:border-white/10 hover:border-indigo-500/30 shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-2"
                  ...
                  <div className="relative p-8">
                    ...
                    <div className="flex items-start justify-between mb-8">
                      <div className="flex items-center space-x-5">
                        ...
                        <div>
                          <h3 className="text-xl font-black text-slate-900 dark:text-white group-hover:text-indigo-400 transition-colors duration-300 leading-tight">
                            {employeeName}
                          </h3>
                      ...
                      {(isHRManager() || isAdmin()) && (
                        <div className="flex items-center space-x-1">
                          <button
                            ...
                            className="p-2 text-slate-500 hover:text-slate-900 dark:text-white hover:bg-black/10 dark:bg-white/10 rounded-xl transition-all duration-200"
                            title="Edit"
                          >
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-center text-sm font-black text-slate-800 dark:text-slate-200 truncate">
        ...
        {employees.length > 0 && (
          <div className="flex justify-center pb-12">
            <div className="inline-flex items-center px-6 py-3 bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl border border-black/10 dark:border-white/10">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">
                  Showing <span className="text-slate-900 dark:text-white font-black">{employees.length}</span> active directory records
                </p>
              </div>
            </div>
          </div>
