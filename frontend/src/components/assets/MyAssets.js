...
const MyAssets = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return `${base} bg-[#070B14]/10 text-slate-400 border-slate-500/20`;
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070B14] py-8 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10 bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 dark:border-white/10 p-8 flex items-center justify-between group overflow-hidden relative">
        ...
        {assets.length === 0 ? (
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 dark:border-white/10 shadow-2xl p-20 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {assets.map((a) => (
              <div key={a.id} className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 dark:border-white/10 shadow-xl p-6 hover:bg-black/10 dark:bg-white/10 transition-all duration-300 group">
                ...
                <div className="space-y-4">
                  <div className="flex items-center px-4 py-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-black/20 dark:border-white/20 transition-all">
                    ...
                    <div>
                      ...
                      <div className="text-slate-900 dark:text-slate-200 font-black tracking-tight">{a.asset_tag}</div>
                    </div>
                  </div>
                  {a.serial_number ? (
                    <div className="flex items-center px-4 py-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-black/20 dark:border-white/20 transition-all">
                      ...
                      <div>
                        ...
                        <div className="text-slate-900 dark:text-slate-200 font-black tracking-tight">{a.serial_number}</div>
                      </div>
                    </div>
                  ) : null}
                  {a.purchased_date ? (
                    <div className="flex items-center px-4 py-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-black/20 dark:border-white/20 transition-all">
                      ...
                      <div>
                        ...
                        <div className="text-slate-900 dark:text-slate-200 font-black tracking-tight">{a.purchased_date}</div>
                      </div>
                    </div>
                  ) : null}
                  {a.laptop_age_pretty ? (
                    <div className="flex items-center px-4 py-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-black/20 dark:border-white/20 transition-all">
                      ...
                      <div>
                        ...
                        <div className="text-slate-900 dark:text-slate-200 font-black tracking-tight">{a.laptop_age_pretty}</div>
                      </div>
                    </div>
                  ) : null}
                  ...
                  {a.previously_used_by_info && assetTypeCategory[a.asset_type] !== 'SOFTWARE' ? (
                    <div className="flex items-center px-4 py-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-black/20 dark:border-white/20 transition-all">
                      ...
                      <div>
                        ...
                        <div className="text-slate-900 dark:text-slate-200 font-black tracking-tight">{a.previously_used_by_info.name}</div>
                      </div>
                    </div>
                  ) : null}
                </div>
