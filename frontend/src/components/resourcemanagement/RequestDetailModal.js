...
export const getStatusBadge = (status) => {
  ...
  switch (status) {
    ...
    default:
      return `${baseClasses} bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-500/30`;
  }
};
...
export const getPriorityBadge = (priority) => {
  ...
  switch (priority) {
    ...
    default:
      return `${baseClasses} bg-gray-500/10 text-gray-600 dark:text-gray-400 border border-gray-500/20`;
  }
};
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-0.5">
                ...
                <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest leading-none font-mono">#{request.ticket_number}</p>
              </div>
            </div>
          </div>
          <button
        ...
        <div className="p-8 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-wider">Priority</label>
            ...
            <div className="space-y-6">
              ...
              {request.expires_at && (
                <div>
                  <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-wider">Expires At</label>
            ...
            <div className="border-t border-white/10 dark:border-white/10 pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 rounded-xl bg-black/20 border border-white/10">
                ...
                {request.status !== 'REJECTED' && request.approved_by && (
                  <div>
                    <label className="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-wider">Approved By</label>
                      ...
                      <div className="relative mt-1">
                        <div className="relative w-full cursor-default overflow-hidden rounded-xl bg-white/5 border border-white/10 dark:border-white/10 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all hover:bg-black/10 dark:bg-white/5/10 hover:border-black/20 dark:border-white/20">
                          ...
                          <Combobox.Button className="absolute inset-y-0 right-0 flex items-center pr-2">
                            <ChevronUpDownIcon className="h-5 w-5 text-gray-600 dark:text-gray-400" aria-hidden="true" />
                          </Combobox.Button>
                        </div>
                        <Transition
                          as={Fragment}
