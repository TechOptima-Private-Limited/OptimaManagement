  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Requests */}
        <div className={`bg-black/5 dark:bg-white/5 rounded-2xl border ${theme.cardBorder} shadow-xl backdrop-blur-sm`}>
              ...
              <div className="space-y-4">
                {recentRequests.map((request) => (
                  <div
                    ...
                    className="flex items-center justify-between p-4 bg-black/5 dark:bg-white/5 rounded-xl border border-black/5 dark:border-white/5 hover:bg-black/10 dark:bg-white/10 transition-all cursor-pointer group"
                  >
                    <div className="flex items-center space-x-3">
                      <div className="p-2 bg-black/5 dark:bg-white/5 rounded-lg group-hover:bg-indigo-500/20 transition-colors">
                        {getStatusIcon(request.status)}
                      </div>
                      <div>
                        <p className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-indigo-400 transition-colors">#{request.ticket_number}</p>
        ...
        <div className={`bg-black/5 dark:bg-white/5 rounded-2xl border ${theme.cardBorder} shadow-xl backdrop-blur-sm`}>
          ...
          <div className="p-6 space-y-4">
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-2.5 rounded-xl group-hover:scale-110 shadow-lg transition-transform">
                  <ServerIcon className="h-5 w-5 text-slate-900 dark:text-white" />
                </div>
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="bg-gradient-to-br from-orange-500 to-amber-600 p-2.5 rounded-xl group-hover:scale-110 shadow-lg transition-transform">
                  <ExclamationTriangleIcon className="h-5 w-5 text-slate-900 dark:text-white" />
                </div>
                <div className="text-left">
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-4 bg-black/5 dark:bg-white/5 rounded-xl border border-black/10 dark:border-white/10 hover:border-black/20 dark:border-white/20 hover:bg-black/10 dark:bg-white/10 hover:shadow-lg transition-all duration-300 group"
            >
              <div className="flex items-center space-x-3">
                <div className="bg-black/10 dark:bg-white/10 p-2.5 rounded-xl group-hover:scale-110 shadow-lg transition-transform border border-black/10 dark:border-white/10">
              ...
              <svg className="h-5 w-5 text-gray-500 group-hover:text-slate-900 dark:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </button>
          </div>
      ...
      <div className={`bg-black/5 dark:bg-white/5 rounded-2xl border ${theme.cardBorder} shadow-xl backdrop-blur-sm`}>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3 p-4 bg-black/5 dark:bg-white/5 rounded-xl border border-black/5 dark:border-white/5">
