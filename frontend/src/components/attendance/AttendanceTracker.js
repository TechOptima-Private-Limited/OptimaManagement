  ...
  return (
    <div className="min-h-screen bg-[#070B14] text-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {canViewApprovals && (
          <div className="bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/10 p-10 mb-12 shadow-2xl relative overflow-hidden" data-approvals-section>
            ...
            {attendanceRecords.filter(r => r.is_pending_approval).length > 0 ? (
                ...
                {attendanceRecords
                  ...
                  .map((record) => (
                    <div key={record.id} className="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-black/10 dark:bg-white/5/10 transition-all duration-300 shadow-inner group">
                        ...
                        <div className="flex items-center space-x-5">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-3 mt-2">
                              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest bg-white/5 px-3 py-1 rounded-full border border-white/10">ID: {record.display_id || 'N/A'}</span>
                      ...
                      {record.edit_reason && (
                        <div className="mb-8 p-6 bg-white/5 border border-white/10 rounded-2xl shadow-inner relative">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* ORIGINAL VALUES */}
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 shadow-inner flex flex-col grayscale opacity-50">
              ...
              <div className="py-24 text-center bg-white/5 rounded-[2.5rem] border border-dashed border-white/10 dark:border-white/10">
