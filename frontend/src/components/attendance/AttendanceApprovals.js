...
const AttendanceApprovals = () => {
  ...
  if (!isHRManager() && !isManager()) {
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
        <div className="text-center p-12 bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl max-w-md">
  ...
  return (
    <div className={`min-h-screen bg-slate-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-slate-950 to-black text-slate-300 pb-12`}>
      {/* Premium Header */}
      <div className="relative overflow-hidden bg-slate-900/20 border-b border-white/5 pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex items-center space-x-6">
            <div className="p-4 bg-gradient-to-br from-indigo-500 to-violet-700 rounded-2xl shadow-2xl shadow-indigo-500/20 transform -rotate-3 border border-white/20">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="px-3 py-1 bg-white/5 rounded-full text-[10px] font-black uppercase tracking-widest border border-white/10 text-slate-400">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-10 sm:px-6 lg:px-8 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <div className="bg-slate-900/60 backdrop-blur-xl rounded-[2rem] border border-white/10 p-6 shadow-2xl group hover:border-indigo-500/30 transition-all duration-500">
          ...
          {pendingApprovals.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-6">
              {pendingApprovals.map((approval) => (
                <div key={approval.id} className="bg-slate-900/60 backdrop-blur-2xl rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl hover:border-white/10 transition-all duration-300 group">
                  <div className="p-8">
                    <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-8">
                      <div className="flex-1">
                        <div className="flex items-start space-x-6">
                          <div className="flex-shrink-0">
                            <div className="h-16 w-16 bg-gradient-to-br from-indigo-500 to-violet-700 rounded-2xl flex items-center justify-center shadow-xl shadow-indigo-500/10 border border-white/10 group-hover:scale-105 transition-transform duration-500 text-white text-2xl font-black uppercase">
                          ...
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                              ...
                              <span className="px-3 py-0.5 bg-white/5 rounded-lg text-xs font-black text-slate-500 border border-white/10 tracking-widest">{approval.employee_id}</span>
                            </div>
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="p-6 bg-slate-950/50 rounded-3xl border border-white/5 relative overflow-hidden">
                        ...
                        {approval.edit_reason && (
                          <div className="mt-4 p-5 bg-white/5 border border-white/5 rounded-2xl">
                      ...
                      <div className="flex flex-row xl:flex-col gap-3 min-w-[200px]">
                        ...
                        <button
                          ...
                          disabled={submitting}
                          className="flex-1 inline-flex items-center justify-center px-8 py-4 bg-slate-800 border border-white/5 rounded-2xl text-xs font-black text-slate-400 uppercase tracking-widest hover:bg-rose-600 hover:text-white hover:border-rose-500 hover:shadow-lg hover:shadow-rose-600/20 transition-all duration-300 disabled:opacity-50"
                        >
