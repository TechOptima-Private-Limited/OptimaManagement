...
const AttendanceApprovals = () => {
  ...
  if (!isHRManager() && !isManager()) {
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
        <div className="text-center p-12 bg-white dark:bg-slate-900/60 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-[2.5rem] shadow-2xl max-w-md">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">Only HR Managers and Team Managers can manage attendance approvals.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`min-h-screen bg-slate-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-slate-950 to-black text-slate-700 dark:text-slate-300 pb-12`}>
      {/* Premium Header */}
      <div className="relative overflow-hidden bg-white dark:bg-slate-900/20 border-b border-black/5 dark:border-white/5 pt-16 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="px-3 py-1 bg-black/5 dark:bg-white/5 rounded-full text-[10px] font-black uppercase tracking-widest border border-black/10 dark:border-white/10 text-slate-500 dark:text-slate-400">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-10 sm:px-6 lg:px-8 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <div className="bg-white dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] border border-black/10 dark:border-white/10 p-6 shadow-2xl group hover:border-indigo-500/30 transition-all duration-500">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between mb-4 px-2">
            <h3 className="text-sm font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.3em] flex items-center">
          ...
          {pendingApprovals.length === 0 ? (
            <div className="bg-white dark:bg-slate-900/40 backdrop-blur-xl rounded-[2.5rem] border border-black/5 dark:border-white/5 p-20 text-center shadow-2xl">
              <div className="w-24 h-24 bg-black/5 dark:bg-white/5 rounded-full flex items-center justify-center mx-auto mb-6 border border-black/5 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 gap-6">
              {pendingApprovals.map((approval) => (
                <div key={approval.id} className="bg-white dark:bg-slate-900/60 backdrop-blur-2xl rounded-[2.5rem] border border-black/5 dark:border-white/5 overflow-hidden shadow-2xl hover:border-black/10 dark:border-white/10 transition-all duration-300 group">
                  <div className="p-8">
                    <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-8">
                      <div className="flex-1">
                        <div className="flex items-start space-x-6">
                          <div className="flex-shrink-0">
                            <div className="h-16 w-16 bg-gradient-to-br from-indigo-500 to-violet-700 rounded-2xl flex items-center justify-center shadow-xl shadow-indigo-500/10 border border-black/10 dark:border-white/10 group-hover:scale-105 transition-transform duration-500 text-slate-900 dark:text-white text-2xl font-black uppercase">
                          ...
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                              ...
                              <span className="px-3 py-0.5 bg-black/5 dark:bg-white/5 rounded-lg text-xs font-black text-slate-500 border border-black/10 dark:border-white/10 tracking-widest">{approval.employee_id}</span>
                            </div>
                            <div className="flex flex-wrap items-center gap-6 text-xs text-slate-500 font-black uppercase tracking-widest">
                              <div className="flex items-center bg-black/5 dark:bg-white/5 px-3 py-1.5 rounded-full border border-black/5 dark:border-white/5">
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="p-6 bg-slate-950/50 rounded-3xl border border-black/5 dark:border-white/5 relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10">
                              <XCircleIcon className="w-12 h-12 text-slate-500 dark:text-slate-400" />
                            </div>
                        ...
                        {approval.edit_reason && (
                          <div className="mt-4 p-5 bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl">
                      ...
                      <div className="flex flex-row xl:flex-col gap-3 min-w-[200px]">
                        ...
                        <button
                          ...
                          disabled={submitting}
                          className="flex-1 inline-flex items-center justify-center px-8 py-4 bg-slate-100 dark:bg-slate-800 border border-black/5 dark:border-white/5 rounded-2xl text-xs font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest hover:bg-rose-600 hover:text-slate-900 dark:text-white hover:border-rose-500 hover:shadow-lg hover:shadow-rose-600/20 transition-all duration-300 disabled:opacity-50"
                        >
