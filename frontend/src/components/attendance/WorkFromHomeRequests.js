...
const WorkFromHomeRequests = () => {
  ...
  const getEmployeeInitials = (name) => getInitials(name);
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme.surfaceGradient}`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-xl text-slate-700 dark:text-blue-100">
                  {getHeaderText()}
                </p>
                <div className="flex items-center space-x-6 text-slate-700 dark:text-blue-100 mt-4">
      ...
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Employee Pending Requests Section - Show for everyone if they have pending requests */}
        {true && (
        ...
        <div className={`${theme.cardBg} backdrop-blur-xl shadow-xl rounded-2xl p-6 mb-6 border ${theme.cardBorder}`}>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
            <div>
              <label className="block text-sm font-semibold text-slate-600 dark:text-gray-300 mb-2">Month</label>
              <input
                type="month"
                value={filters.month}
                onChange={(e) => handleFilterChange('month', e.target.value)}
                className="w-full px-4 py-3 border border-black/20 dark:border-white/20 rounded-xl bg-white/5 text-slate-900 dark:text-white backdrop-blur-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 outline-none placeholder-gray-500 [color-scheme:dark]"
              />
            </div>

            <div>
              <label className="block text-sm font-semibold text-slate-600 dark:text-gray-300 mb-2">Status</label>
              <select
                value={filters.status}
                onChange={(e) => handleFilterChange('status', e.target.value)}
                className="w-full px-4 py-3 border border-black/20 dark:border-white/20 rounded-xl bg-[#070B14] dark:bg-[#1e1e2d] text-slate-900 dark:text-white backdrop-blur-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 outline-none"
              >
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full bg-black/10 dark:bg-white/10 text-slate-900 dark:text-white px-4 py-3 rounded-xl hover:bg-black/20 dark:bg-white/20 border border-white/10 dark:border-white/10 focus:outline-none focus:ring-4 focus:ring-white/20 inline-flex items-center justify-center transform hover:scale-105 transition-all duration-200"
              >
      ...
      {/* Enhanced New Request Modal - Always accessible */}
      {true && (
        <Modal
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-black/20 dark:border-white/20 rounded-xl bg-white/5 text-slate-900 dark:text-white backdrop-blur-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 outline-none [color-scheme:dark]"
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-black/20 dark:border-white/20 rounded-xl bg-white/5 text-slate-900 dark:text-white backdrop-blur-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 outline-none resize-none placeholder-gray-500"
                />
            ...
            <div className="flex space-x-3 pt-6">
              ...
              <button
                ...
                className="flex-1 bg-black/10 dark:bg-white/10 text-slate-900 dark:text-white px-4 py-3 rounded-xl hover:bg-black/20 dark:bg-white/20 border border-white/10 dark:border-white/10 focus:outline-none focus:ring-4 focus:ring-white/20 transform hover:scale-105 transition-all duration-200"
              >
                Cancel
              </button>
            </div>
                ...
                <div className="space-y-4">
                  {canViewAllRequests() && (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2">{selectedRequest.employee_department}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1">Employee ID:</label>
                        <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2">{selectedRequest.employee_id}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2">{selectedRequest.formatted_applied_at}</p>
                    </div>
                  </div>
                  ...
                  {selectedRequest.approved_by_name && (
                    <div>
                      ...
                      <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2">{selectedRequest.approved_by_name}</p>
                    </div>
                  )}
            ...
            <div className="mb-6">
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2 mt-1">{selectedApproval.employee_department}</p>
                </div>
                <div>
                  <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">Employee ID:</span>
                  <p className="text-sm text-slate-900 dark:text-white bg-white/5 border border-white/10 dark:border-white/10 rounded-lg px-3 py-2 mt-1">{selectedApproval.employee_id}</p>
                </div>
              </div>
            ...
            {selectedApproval.action === 'reject' && (
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-black/20 dark:border-white/20 rounded-xl bg-white/5 text-slate-900 dark:text-white backdrop-blur-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 outline-none resize-none"
                />
              </div>
            )}
            ...
            {selectedApproval.action !== 'view' ? (
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 bg-black/10 dark:bg-white/10 border border-white/10 dark:border-white/10 text-slate-900 dark:text-white px-4 py-3 rounded-xl hover:bg-black/20 dark:bg-white/20 focus:outline-none focus:ring-4 focus:ring-white/20 transform hover:scale-105 transition-all duration-200"
                >
                  Cancel
                </button>
              </div>
              ...
              <div className="flex justify-end pt-4">
                <button
                  ...
                  className="bg-black/10 dark:bg-white/10 border border-white/10 dark:border-white/10 text-slate-900 dark:text-white px-6 py-3 rounded-xl hover:bg-black/20 dark:bg-white/20 focus:outline-none focus:ring-4 focus:ring-white/20 transform hover:scale-105 transition-all duration-200"
                >
                  Close
                </button>
              </div>
