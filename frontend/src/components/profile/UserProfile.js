...
//         setEmployee(employeeProfileData.employee);
...
//             My Profile
//           </h1>
//           <p className="text-gray-600 mt-2">Manage your personal information and view your team</p>
//         </div>
...
//                     <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-xl border-4 border-white">
...
//             {manager && (
//               <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
//                 <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-700 px-6 py-4">
//                   <h2 className="text-xl font-bold text-white flex items-center">
...
//                     <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white text-lg font-bold shadow-lg">
...
//             {/* Team Members */}
//             <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-white/20">
//               <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-700 px-6 py-4">
//                 <h2 className="text-xl font-bold text-white flex items-center">
...
//                   <span className="font-bold text-blue-600">{team.length}</span>
//                 </div>
//                 <div className="flex justify-between items-center">
