      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
          <div className="p-8 lg:p-12">
            ...
            {generatedLink && linkInfo && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h4 className="font-bold text-blue-800">Creation Details</h4>
                    </div>
                    <div className="space-y-2 text-sm">
                      <div>
                        <span className="font-semibold text-blue-700">Created:</span>
                        <p className="text-blue-600">{linkInfo.created.toLocaleString()}</p>
                      </div>
                      <div>
                        <span className="font-semibold text-blue-700">Expires:</span>
                        <p className="text-blue-600">{linkInfo.expires.toLocaleString()}</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-6 border border-gray-200">
                  ...
                  <div className="relative">
                    <textarea
                      value={generatedLink}
                      readOnly
                      className="w-full h-24 p-4 font-mono text-sm bg-white border-2 border-gray-300 rounded-xl resize-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-200"
                ...
                <details className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl border border-gray-200">
                  ...
                  <div className="p-4 pt-0 space-y-3 text-sm text-gray-600">
                    <div>
            ...
            {/* Help Section */}
            {!generatedLink && (
              <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-blue-800 mb-2">Generate Link</h4>
                    <p className="text-blue-600">Click the button to create a unique, timestamped onboarding link</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold">2</span>
                    </div>
                    <h4 className="font-semibold text-blue-800 mb-2">Share with Employees</h4>
                    <p className="text-blue-600">Send the link via email to employees who need to complete onboarding</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold">3</span>
                    </div>
                    <h4 className="font-semibold text-blue-800 mb-2">Track Submissions</h4>
                    <p className="text-blue-600">Monitor employee submissions through the employee management system</p>
                  </div>
                </div>
              </div>
            )}
