          ...
          <div className="p-8 lg:p-12">
            ...
            {generatedLink && linkInfo && (
              <div className="space-y-6 animate-fadeIn">
                ...
                {/* Generated Link */}
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="relative">
                    <textarea
                      value={generatedLink}
                      readOnly
                      className="w-full h-24 p-4 font-mono text-sm bg-[#070B14] dark:bg-slate-900/50 border-2 border-slate-700/50 rounded-xl resize-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 text-white transition-all duration-200"
                ...
                {/* Instructions */}
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border-l-4 border-amber-500/20">
                  <div className="flex items-start space-x-3">
                    <AlertTriangle className="w-6 h-6 text-amber-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-bold text-amber-400 mb-3">Important Instructions</h4>
                ...
                <details className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl border border-white/10">
                  <summary className="p-4 font-semibold text-white cursor-pointer hover:bg-white/5/10 rounded-2xl transition-colors duration-200">
