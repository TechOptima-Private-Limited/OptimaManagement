    ...
    <div className="min-h-screen bg-slate-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-slate-900 to-black text-slate-300 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <div className="bg-[#070B14] dark:bg-slate-900/60 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-2xl shadow-lg p-6 hover:bg-[#070B14] dark:bg-slate-900/80 transition-all duration-300 group">
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-11 pr-4 py-3 bg-black/20 border border-black/10 dark:border-white/10 rounded-xl leading-5 text-slate-300 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 focus:bg-black/40 transition-all duration-200"
            />
          </div>
        </div>

        {/* Offboardings List */}
        <div className="bg-[#070B14] dark:bg-slate-900/60 backdrop-blur-xl shadow-xl overflow-hidden rounded-2xl border border-black/10 dark:border-white/10">
          <ul className="divide-y divide-white/5">
            {filteredOffboardings.length === 0 ? (
              <div className="text-center py-16">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-white/5/5 border border-black/10 dark:border-white/10 rounded-full mb-4 shadow-inner">
              ...
              filteredOffboardings.map((offboarding) => (
                <li key={offboarding.id} className="px-6 py-5 hover:bg-white/5/5 transition-colors duration-150 group">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3 opacity-80 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="inline-flex items-center px-3 py-2 border border-black/10 dark:border-white/10 rounded-lg text-sm font-medium text-slate-300 bg-black/20 hover:bg-black/10 dark:bg-white/5/10 hover:text-white transition-colors"
                      >
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block align-bottom bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="block w-full bg-black/20 border border-black/10 dark:border-white/10 rounded-xl shadow-sm py-2.5 px-3 text-slate-300 placeholder-slate-500 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50"
                        />
                        {showEmployeeDropdown && (
                          <div className="absolute z-20 mt-1 w-full bg-[#070B14] dark:bg-slate-900 border border-black/10 dark:border-white/10 rounded-xl shadow-lg max-h-56 overflow-y-auto">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full bg-black/20 border border-black/10 dark:border-white/10 rounded-xl shadow-sm py-2.5 px-3 text-white placeholder-slate-500 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full bg-black/20 border border-black/10 dark:border-white/10 rounded-xl shadow-sm py-2 px-3 text-slate-300 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-500/20 file:text-indigo-300 hover:file:bg-indigo-500/30 transition-all focus:outline-none"
                      />
                ...
                <div className="bg-white/5/5 border-t border-black/10 dark:border-white/10 px-6 py-4 sm:flex sm:flex-row-reverse">
                  <button
                  ...
                  <button
                    ...
                    className="mt-3 w-full inline-flex justify-center rounded-xl border border-black/10 dark:border-white/10 shadow-sm px-6 py-2.5 bg-white/5/5 text-base font-medium text-slate-300 hover:bg-black/10 dark:bg-white/5/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0A0F1A] focus:ring-slate-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm transition-all"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="inline-block align-bottom bg-[#0A0F1A] border border-black/10 dark:border-white/10 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div className="px-6 pt-6 pb-4 sm:p-8 sm:pb-6">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2 bg-white/5/5 border border-black/10 dark:border-white/10 rounded-xl p-4">
                ...
                <div className="bg-white/5/5 border-t border-black/10 dark:border-white/10 px-6 py-4 sm:flex sm:flex-row-reverse">
                  <button
                    ...
                    className="w-full inline-flex justify-center rounded-xl border border-black/10 dark:border-white/10 shadow-sm px-6 py-2.5 bg-white/5/5 text-base font-medium text-white hover:bg-black/10 dark:bg-white/5/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0A0F1A] focus:ring-slate-500 sm:ml-3 sm:w-auto sm:text-sm transition-all"
                  >
                    Close
                  </button>
                </div>
