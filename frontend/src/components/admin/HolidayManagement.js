        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#070B14] p-8 space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button
                    ...
                    className={`flex items-center justify-center px-6 py-3 bg-gradient-to-r ${theme.primaryGradient} text-slate-900 dark:text-white rounded-2xl shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:scale-105 active:scale-95 transition-all duration-300 text-xs font-black uppercase tracking-widest`}
                >
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {holidays.map((holiday) => (
                        <div
                            key={holiday.id}
                            className="bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-black/5 dark:border-white/5 p-8 hover:border-black/20 dark:border-white/20 hover:bg-black/10 dark:bg-white/10 transition-all duration-500 relative overflow-hidden group shadow-2xl"
                        >
                            ...
                            <div className="flex justify-between items-start mb-6 relative z-10">
                                ...
                                <div className="flex space-x-2">
                                    <button
                                        ...
                                        className="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-black/10 dark:bg-white/10 rounded-xl transition-all"
                                    >
                            ...
                            <div className="space-y-6 mb-2 relative z-10">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <span className="px-3 py-1 bg-black/5 dark:bg-white/5 text-slate-500 text-[9px] font-black uppercase tracking-widest rounded-full border border-black/5 dark:border-white/5 whitespace-nowrap">
                    ...
                    {holidays.length === 0 && (
                        <div className="col-span-full py-32 text-center bg-black/5 dark:bg-white/5 rounded-3xl border-2 border-dashed border-black/10 dark:border-white/10">
                            ...
                            <button
                                onClick={() => handleOpenModal()}
                                className="mt-8 px-8 py-3 bg-black/10 dark:bg-white/10 hover:bg-black/20 dark:bg-white/20 text-slate-900 dark:text-white rounded-2xl text-xs font-black uppercase tracking-widest transition-all"
                            >
                                START REGISTRY
                            </button>
                        </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-[#0B1120] rounded-[2.5rem] border border-black/10 dark:border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full max-w-lg overflow-hidden transform animate-in zoom-in-95 duration-200">
                        <div className={`p-10 bg-gradient-to-br ${theme.primaryGradient} relative overflow-hidden`}>
                            <div className="absolute top-0 right-0 w-64 h-64 bg-black/10 dark:bg-white/10 blur-3xl rounded-full -translate-y-1/2 translate-x-1/3"></div>
                            <div className="relative z-10 flex justify-between items-center">
                                <div>
                                    <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-none">{editingHoliday ? 'Modify Entry' : 'New Registry'}</h2>
                                    <p className="text-slate-900 dark:text-white/60 text-xs font-black uppercase tracking-widest mt-2">Calendar Configuration Protocol</p>
                                </div>
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="p-3 hover:bg-black/20 dark:bg-white/20 rounded-2xl transition-all"
                                >
                                    <XCircleIcon className="h-7 w-7 text-slate-900 dark:text-white" />
                                </button>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-10 space-y-8 max-h-[75vh] overflow-y-auto custom-scrollbar">
                            <div className="space-y-2">
                                ...
                                <input
                                    type="text"
                                    required
                                    className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-sm text-slate-900 dark:text-white placeholder-slate-600 focus:ring-2 focus:ring-indigo-500/50 shadow-inner outline-none font-bold"
                                    value={formData.name}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="date"
                                        required
                                        className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-sm text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500/50 shadow-inner outline-none font-bold [color-scheme:dark]"
                                        value={formData.date}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="text"
                                        className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-center text-2xl focus:ring-2 focus:ring-indigo-500/50 shadow-inner outline-none"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-sm text-slate-900 dark:text-white placeholder-slate-600 focus:ring-2 focus:ring-indigo-500/50 shadow-inner outline-none min-h-[120px] font-medium leading-relaxed"
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-sm text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500/50 shadow-inner outline-none appearance-none font-bold bg-no-repeat bg-[right_1.5rem_center] bg-[length:1em_1em]"
                            ...
                            <div className="flex gap-4 pt-4">
                                <button
                                    type="button"
                                    onClick={() => setIsModalOpen(false)}
                                    className="flex-1 px-6 py-4 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-500 dark:text-slate-400 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-black/10 dark:bg-white/10 hover:text-slate-900 dark:text-white transition-all transform active:scale-95"
                                >
                                    Discard
                                </button>
                                <button
                                    type="submit"
                                    className={`flex-[2] px-6 py-4 bg-gradient-to-r ${theme.primaryGradient} text-slate-900 dark:text-white rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl hover:shadow-[0_0_25px_rgba(99,102,241,0.4)] transition-all transform hover:scale-[1.02] active:scale-[0.98]`}
                                >
...
const Toggle = ({ label, checked, onChange }) => (
    <label className="flex items-center group cursor-pointer justify-between bg-black/5 dark:bg-white/5 px-6 py-4 rounded-2xl border border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10 transition-all">
