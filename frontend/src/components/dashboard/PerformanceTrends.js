        ...
        <div className="bg-white dark:bg-slate-900/90 backdrop-blur-md border border-black/10 dark:border-white/10 p-3 rounded-xl shadow-2xl">
          ...
          {payload[0].payload.status && (
            <p className={`text-[9px] font-bold uppercase mt-1 ${
              payload[0].payload.status === 'PRESENT' ? 'text-emerald-400' : 
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-6 border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden group">
