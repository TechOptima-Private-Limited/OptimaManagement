...
const WorkingFormatCard = () => {
  ...
  return (
    <div className="bg-[#0b1221] rounded-3xl p-5 shadow-2xl relative overflow-hidden group border border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10 transition-all duration-300 min-h-[300px] card-hover-lift smooth-transition">
      {/* Background Glow */}
