...
const DashboardSkeleton = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 animate-in fade-in duration-300">
      ...
      <div className="bg-white/5 dark:bg-slate-900 border-b border-white/10 px-4 sm:px-8 py-6 sm:py-10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-3">
            <Shimmer className="h-4 w-20 sm:w-24 rounded-full" />
            <Shimmer className="h-8 sm:h-10 w-48 sm:w-64" />
            <Shimmer className="h-3 sm:h-4 w-32 sm:w-48" />
          </div>
          <div className="sm:text-right space-y-2">
            <Shimmer className="h-7 sm:h-9 w-28 sm:w-36 sm:ml-auto" />
            <Shimmer className="h-3 sm:h-4 w-20 sm:w-24 sm:ml-auto" />
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-2 bg-white/5 dark:bg-slate-800/80 backdrop-blur-md rounded-full border border-white/10 dark:border-white/10 shadow-xl z-50">
