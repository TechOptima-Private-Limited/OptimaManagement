...
//           className="flex items-center justify-center py-4 px-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-xl font-semibold transition-all duration-300 disabled:opacity-50 shadow-lg text-white"
//         >
...
//         <button
//           disabled={true}
//           className="flex items-center justify-center py-4 px-6 bg-gradient-to-r from-yellow-500 to-orange-500 opacity-75 rounded-xl font-semibold cursor-not-allowed shadow-lg text-white"
//         >
...
//           disabled={submittingAttendance}
//           className="flex items-center justify-center py-4 px-6 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 rounded-xl font-semibold transition-all duration-300 disabled:opacity-50 shadow-lg text-white"
//         >
//           <HomeIcon className="w-5 h-5 mr-2" />
...
//       <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white border-b border-white/20 px-6 py-6 shadow-xl">
//         <div className="flex items-center justify-between">
//           <div>
...
//                 <div className="text-orange-200 text-xs mt-1 font-medium">
//                   📝 Pending submission
//                 </div>
//               )}
//             </div>
...
//                   <span className="font-medium">{getShiftInfo()}</span>
//                 </div>
...
//                   <div className="mt-4 p-3 bg-blue-500/20 border border-blue-500/30 rounded-lg backdrop-blur-sm">
...
//                 {attendanceState.pendingSubmission && (
//                   <div className="mt-4 p-3 bg-orange-500/20 border border-orange-500/30 rounded-lg backdrop-blur-sm">
...
//                 <div className="bg-gradient-to-r from-yellow-50 to-orange-100 rounded-xl p-6 border border-yellow-200">
//                   <div className="flex items-center mb-4">
//                     <div className="w-10 h-10 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center mr-4 shadow-lg">
//                       <span className="text-white font-bold text-sm">Me</span>
//                     </div>
//                     <span className="font-semibold text-gray-900 text-lg">My Performance</span>
//                   </div>
//                   <div className="grid grid-cols-2 gap-4">
//                     <div className="bg-white/50 rounded-lg p-4 backdrop-blur-sm border border-white/20">
//                       <div className="text-sm text-gray-600 font-medium">AVG HRS / DAY</div>
//                       <div className="text-2xl font-bold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">{dashboardData.attendanceStats?.teamOnTime}</div>
//                     </div>
//                     <div className="bg-white/50 rounded-lg p-4 backdrop-blur-sm border border-white/20">
//                       <div className="text-sm text-gray-600 font-medium">THIS MONTH</div>
//                       <div className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">92%</div>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//             {isHRManager() && (
//               <QuickAccessCard title="👥 Upcoming Team Leaves" gradient={true}>
//                 <div className="space-y-3">
...
//                       </div>
//                       <p className="text-gray-500 text-sm font-medium">No upcoming leaves</p>
//                     </div>
//                   ) : (
//                     dashboardData.upcomingLeaves.map((leave) => (
//                       <div key={leave.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-300">
//                         <div>
//                           <div className="font-semibold text-gray-900">{leave.employee}</div>
