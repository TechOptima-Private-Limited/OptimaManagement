...
const Login = () => {
  ...
  const inputClass =
    'appearance-none block w-full px-4 py-5 sm:py-4 rounded-2xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 text-slate-900 dark:text-white placeholder-gray-500 shadow-inner focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500/50 transition-all duration-300 text-base sm:text-sm font-medium backdrop-blur-sm';

  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#070B14] overflow-hidden relative font-sans selection:bg-purple-500/30" style={{ WebkitTapHighlightColor: 'transparent' }}>
      {/* ── Background Layer ── */}
      <div className="absolute inset-0 z-0 bg-slate-50 dark:bg-[#070B14]">
        <img 
          src={loginBg} 
        ...
        <div className="absolute inset-0 backdrop-blur-md sm:backdrop-blur-sm bg-slate-50 dark:bg-[#070B14]/60 sm:bg-slate-50 dark:bg-[#070B14]/50" />
      ...
      <div className="relative z-10 w-full flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="absolute top-5 left-5 sm:top-10 sm:left-10 flex items-center space-x-3 sm:space-x-4 group cursor-default">
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-700 flex items-center justify-center shadow-xl shadow-purple-500/20">
            <BuildingOfficeIcon className="h-4 w-4 sm:h-5 sm:w-5 text-slate-900 dark:text-white" />
          </div>
          <div>
            <span className="text-slate-900 dark:text-white font-black text-lg sm:text-xl tracking-tighter uppercase block leading-none">Optima</span>
        ...
        <div className="w-full flex items-center justify-center px-4 py-4 sm:p-8 md:p-12 pt-20 sm:pt-24 md:pt-0 min-h-screen">
          <div className="w-full max-w-[480px]">
            <div className="bg-black/5 dark:bg-white/5 backdrop-blur-2xl rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] border border-black/10 dark:border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] p-6 sm:p-9 md:p-12 relative overflow-hidden">
            ...
            <div className="mb-6 sm:mb-8 md:mb-10 text-center sm:text-left">
              ...
              <h2 className="text-gray-500 font-medium text-[10px] sm:text-xs tracking-wide uppercase">Sign in to your account</h2>
            </div>
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              {/* Password */}
              <div>
                  <label className="block text-[10px] font-black text-gray-600 dark:text-gray-400/80 mb-3 uppercase tracking-[0.2em]">
                    Password
                  </label>
                <div className="relative">
                  <input
              ...
              <div className="flex items-center justify-between pb-2 sm:pb-4">
                <label className="flex items-center space-x-3 cursor-pointer group">
                  <div className="relative flex items-center">
                    <input
                      type="checkbox"
                      className="peer h-5 w-5 bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 rounded-lg text-indigo-600 focus:ring-indigo-500/30 transition-all cursor-pointer"
                    />
                  </div>
                  <span className="text-xs font-bold text-gray-500 group-hover:text-gray-600 dark:text-gray-400 transition-colors uppercase tracking-widest">Remember Me</span>
                </label>
                <Link
                  to="/forgot-password"
              ...
              <button
                ...
                className="w-full py-5 sm:py-5 rounded-[1.5rem] sm:rounded-[2rem] bg-gradient-to-r from-[#6366F1] via-[#8B5CF6] to-[#A78BFA] text-slate-900 dark:text-white font-black text-sm uppercase tracking-[0.2em] sm:tracking-[0.25em] shadow-[0_20px_40px_-10px_rgba(139,92,246,0.3)] hover:shadow-[0_28px_55px_-10px_rgba(139,92,246,0.55)] hover:scale-[1.02] active:scale-[0.97] active:shadow-[0_10px_25px_-8px_rgba(139,92,246,0.4)] transition-all duration-300 ease-out disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
