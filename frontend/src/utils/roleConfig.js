...
export const getRoleBadgeColor = (role) => {
  const category = getRoleCategory(role);
  const colorMap = {
    'C_LEVEL': 'bg-gradient-to-r from-indigo-700 to-violet-800 text-white shadow-sm',
    'VP_LEVEL': 'bg-gradient-to-r from-indigo-600 to-indigo-700 text-white shadow-sm',
    'DIRECTOR_LEVEL': 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-sm',
    'MANAGEMENT': 'bg-gradient-to-r from-slate-700 to-slate-800 text-white shadow-sm',
    'TEAM_LEADS': 'bg-gradient-to-r from-indigo-500 to-indigo-600 text-white shadow-sm',
    'SENIOR_STAFF': 'bg-gradient-to-r from-slate-600 to-slate-700 text-white shadow-sm',
    'ADMIN_STAFF': 'bg-gradient-to-r from-indigo-700 to-blue-800 text-white shadow-sm',
    'HR_STAFF': 'bg-gradient-to-r from-violet-600 to-indigo-700 text-white shadow-sm',
    'IT_SUPPORT': 'bg-gradient-to-r from-slate-600 to-slate-700 text-white shadow-sm',
    'ENGINEERING': 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm',
    'QA': 'bg-gradient-to-r from-teal-600 to-emerald-700 text-white shadow-sm',
    'DEVOPS': 'bg-gradient-to-r from-slate-700 to-slate-800 text-white shadow-sm',
    'DATA_AI': 'bg-gradient-to-r from-violet-500 to-indigo-600 text-white shadow-sm',
    'SECURITY': 'bg-gradient-to-r from-slate-800 to-black text-white shadow-sm',
    'DESIGN': 'bg-gradient-to-r from-fuchsia-600 to-violet-700 text-white shadow-sm',
    'PRODUCT': 'bg-gradient-to-r from-indigo-500 to-blue-600 text-white shadow-sm',
    'SUPPORT': 'bg-gradient-to-r from-slate-500 to-slate-600 text-white shadow-sm',
    'SALES_MARKETING': 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-sm',
    'FINANCE': 'bg-gradient-to-r from-emerald-600 to-teal-700 text-white shadow-sm',
    'LEGAL': 'bg-gradient-to-r from-slate-900 to-slate-800 text-white shadow-sm',
    'OPERATIONS': 'bg-gradient-to-r from-slate-600 to-slate-700 text-white shadow-sm',
    'ENTRY_LEVEL': 'bg-gradient-to-r from-slate-300 to-slate-400 text-slate-800 shadow-sm',
    'CONTRACTORS': 'bg-gradient-to-r from-slate-400 to-slate-500 text-white shadow-sm',
