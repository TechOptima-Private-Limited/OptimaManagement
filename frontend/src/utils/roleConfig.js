...
export const getRoleBadgeColor = (role) => {
  const category = getRoleCategory(role);
  const colorMap = {
    'C_LEVEL': 'bg-gradient-to-r from-purple-600 to-pink-700 text-white',
    'VP_LEVEL': 'bg-gradient-to-r from-indigo-600 to-purple-700 text-white',
    'DIRECTOR_LEVEL': 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white',
    'MANAGEMENT': 'bg-gradient-to-r from-orange-500 to-amber-600 text-white',
    'TEAM_LEADS': 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white',
    'SENIOR_STAFF': 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white',
    'ADMIN_STAFF': 'bg-gradient-to-r from-red-500 to-pink-600 text-white',
    'HR_STAFF': 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white',
    'IT_SUPPORT': 'bg-gradient-to-r from-purple-500 to-violet-600 text-white',
    'ENGINEERING': 'bg-gradient-to-r from-blue-400 to-cyan-500 text-white',
    'QA': 'bg-gradient-to-r from-green-500 to-emerald-500 text-white',
    'DEVOPS': 'bg-gradient-to-r from-gray-500 to-slate-600 text-white',
    'DATA_AI': 'bg-gradient-to-r from-violet-500 to-purple-600 text-white',
    'SECURITY': 'bg-gradient-to-r from-red-600 to-rose-700 text-white',
    'DESIGN': 'bg-gradient-to-r from-pink-500 to-rose-600 text-white',
    'PRODUCT': 'bg-gradient-to-r from-amber-500 to-orange-600 text-white',
    'SUPPORT': 'bg-gradient-to-r from-teal-500 to-cyan-600 text-white',
    'SALES_MARKETING': 'bg-gradient-to-r from-lime-500 to-green-600 text-white',
    'FINANCE': 'bg-gradient-to-r from-yellow-600 to-amber-700 text-white',
    'LEGAL': 'bg-gradient-to-r from-slate-600 to-gray-700 text-white',
    'OPERATIONS': 'bg-gradient-to-r from-indigo-500 to-blue-600 text-white',
    'ENTRY_LEVEL': 'bg-gradient-to-r from-sky-400 to-blue-500 text-white',
    'CONTRACTORS': 'bg-gradient-to-r from-gray-400 to-slate-500 text-white',
    'OTHERS': 'bg-gradient-to-r from-green-500 to-emerald-600 text-white',
  };
  return colorMap[category] || 'bg-gradient-to-r from-green-500 to-emerald-600 text-white';
};
